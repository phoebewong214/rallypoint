#!/usr/bin/env python3
"""Render MILESTONE_2_VIDEO_SCRIPT.md (中英混排) into a clean PDF."""
import re
...
SRC = "/Users/phoebewang/Desktop/rallypoint/docs/MILESTONE_2_VIDEO_SCRIPT.md"
OUT = "/Users/phoebewang/Desktop/rallypoint/docs/MILESTONE_2_VIDEO_SCRIPT.pdf"
...
story = [
    ...
    Paragraph("Milestone 2 演示视频脚本 · Demo Video Script (Backend Component)", subtitle),
    Spacer(1, 6),
]
...
def footer(canvas, doc):
    ...
    canvas.drawString(0.85 * inch, 0.5 * inch, "RallyPoint — Milestone 2 Video Script")
...
doc = SimpleDocTemplate(
    ...
    title="RallyPoint — Milestone 2 Video Script", author="Phoebe Wang",
)
