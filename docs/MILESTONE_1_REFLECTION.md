...
This is my Milestone 1 reflection for RallyPoint, an AI-powered partner-matching platform for college tennis and pickleball players. As an Information Systems Capstone, I have written it to emphasize the three things the project actually turns on — solution architecture, applied AI, and defensible business value — and I have organized it to follow the rubric, one section per area, with every market or technology claim tied to a numbered source in the references list at the end.
